...
const MuiBoxItemOne = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="red" />
);
const MuiBoxItemTwo = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="orange" />
);
const MuiBoxItemThree = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="yellow" />
);
const MuiBoxItemFour = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="green" />
);
const MuiBoxItemFive = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="blue" />
);
const MuiBoxItemSix = () => (
  <Box width="5px" height="5px" ml="5px" bgcolor="violet" />
);
